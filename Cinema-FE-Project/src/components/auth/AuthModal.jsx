    ...
    return (
        ...
        >
            <div
                ...
                className={`
                    relative w-[90%] max-w-[450px] max-h-[min(90dvh,calc(100vh-2rem))] overflow-y-auto overscroll-contain
                    p-8 md:p-14 rounded-md bg-black/90
                    border border-white/5 shadow-2xl
                    transform transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]
                    ${show ? "translate-x-[-50%] translate-y-[-50%] scale-100 opacity-100" : "translate-x-[50%] translate-y-[-120%] scale-0 opacity-0"}
                `}
            >
